...
const DUMMY_USERS = {
  ...
  'client@novafi.com': { password: 'password123', role: 'client' },
};
      ...
      <div className="p-6 md:p-10 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="relative mb-10">
            ...
            />
            {errors.email && <p className="absolute -bottom-6 text-xs text-red-500">{errors.email}</p>}
          </div>
          ...
          <div className="relative">
            ...
            />
            {errors.password && <p className="absolute -bottom-6 text-xs text-red-500">{errors.password}</p>}
          </div>
          
          {/* Enlace de Olvidó la Contraseña */}
          <div className="flex justify-end">
            <a href="/forgot-password" className="text-sm font-medium text-gray-400 hover:text-indigo-400">
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-400">
            ¿No tienes una cuenta? <a href="/register" className="text-indigo-400 hover:text-indigo-500 font-bold">Regístrate aquí</a>
          </p>
        </div>
      </div>
    </div>
