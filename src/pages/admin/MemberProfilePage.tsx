...
export const MemberProfilePage: React.FC = () => {
  ...
  if (!member) {
    ...
    return (
      <div className="p-8 text-headline h-screen">
        <Button
          variant="link"
          onClick={() => navigate('/admin/members')}
          className="mb-6 text-highlight/30 p-0 cursor-pointer"
        >
          <ArrowLeft className="w-5 h-5 mr-2" /> Volver a Miembros
        </Button>
        <h1 className="text-3xl font-bold">Miembro no encontrado.</h1>
        <p className="text-sub-headline mt-2">
  ...
  const Avatar = () => (
    <div className="w-24 h-24 rounded-full bg-highlight flex items-center justify-center text-4xl font-bold text-headline overflow-hidden">
    ...
    <div className="min-h-screen p-4 lg:p-8 space-y-6">
      <div className="flex justify-between items-center mb-6">
        <Button
          variant="link"
          onClick={() => navigate('/admin/members')}
          className="text-highlight hover:text-highlight/70 p-0 cursor-pointer"
        >
          <ArrowLeft className="w-5 h-5 mr-2" /> Volver a Miembros
        </Button>
      </div>
      ...
      <Card className="bg-background border-none mt-8">
        <CardContent className="p-0 flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
          ...
          <div className="flex-1 space-y-1">
            <h2 className="text-3xl font-extrabold text-headline">
              {member.nombre}
            </h2>
            <p className="text-sm text-sub-headline">ID: {member.id}</p>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="space-y-6 mb-8">
          <Card className="bg-background border-none p-0">
            <CardHeader>
              <CardTitle className="text-xl font-semibold text-headline border-b border-secondary/20 pb-3">
                Información Personal
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sub-headline text-sm">
        ...
        <div className="lg:col-span-2 space-y-6">
          <CardTitle className="text-xl font-semibold text-headline">
          ...
          <Card className="bg-card-background border-sm border-secondary/30 shadow-md p-6">
            <CardContent className="p-0">
              <Table>
                <TableHeader>
                  <TableRow className="border-secondary/20 bg-card-background hover:bg-card-background">
      ...
      <div className="space-y-6 mt-8">
              ...
              <TableBody>
                {paymentHistory.map((p, index) => (
                  ...
                  >
                    ...
                    <TableCell className="text-tertiary font-semibold">
                      ${p.monto.toFixed(2)}
                    </TableCell>
                    <TableCell className="text-sub-headline">
                      {p.metodo}
        ...
        {/* ASISTENCIA A CLASES */}
        <CardTitle className="text-xl font-semibold text-headline pt-2">
          Asistencia a Clases
        </CardTitle>
        <Card className="bg-card-background border-sm border-secondary/30 shadow-md p-6">
          <CardContent className="p-0">
        ...
        <Card className="bg-card-background border-sm border-secondary/30 shadow-md">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-headline border-b border-secondary/30 pb-3">
              Notas Adicionales
            </CardTitle>
          </CardHeader>
          <CardContent className="text-headline text-sm">
            <p>{notes.note}</p>
          </CardContent>
        </Card>
      </div>
